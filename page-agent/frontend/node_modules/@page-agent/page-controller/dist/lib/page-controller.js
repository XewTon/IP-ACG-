...
//#endregion
//#region src/dom/dom_tree/index.js
/**
	...
	*/
	initMask() {
		...
		this.maskReady = (async () => {
			const { SimulatorMask } = await import("./SimulatorMask-BHVXyogh.js");
...
//#endregion
export { PageController, clickElement, getElementByIndex, inputTextElement, scrollHorizontally, scrollIntoViewIfNeeded, scrollVertically, selectOptionElement };
